...
import {
  startCreateSponsoringValidation,
  startUpdateSponsoringValidation,
} from "../../redux/sponsoring/sponsoring.actions";
import { useDispatch } from "react-redux";
import { getOneSponsoringValidation } from "../../services/sponsoring.services";
...
const SponsoringValidationForm = ({
  visible,
  onCancel,
  id,
  validationId,
  ...
  useEffect(() => {
    ...
    const getValidation = async () => {
      try {
        const { data: validation } = await getOneSponsoringValidation(
          validationId
        );
        setValues({
...
export default SponsoringValidationForm;
